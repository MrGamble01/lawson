...
(async () => {
  ...
  assert.equal(ids.musicSong.attrs['aria-label'], 'Stop song', 'Song button names the next action');
  ...
  assert.equal(ids.musicSong.attrs['aria-label'], 'Play song', 'Song button names the next action');
